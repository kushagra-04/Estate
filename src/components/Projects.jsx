...
const Projects = () => {
  ...
  return (
    ...
    className='flex flex-col items-center justify-center container mx-auto p-14 md:px-20 lg:px-32 w-full overflow-hidden' id='Projects'>
        ...
        <div className='overflow-hidden'>
          <div className='flex gap-8 transition-transform ease-in-out  duration-500' style={{transform:`translateX(-${(currentIndex*100)/cardsToShow}%)`}}>
            {projectsData.map((project,index)=>(
              <div className='relative flex-shrink-0 w-full sm:w-1/4' key={index}>
                ...
                <div className='absolute bottom-5 left-0 right-0 flex justify-center'>
                  <div className='inline-block text-center bg-white w-3/4  px-4 py-2 shadow-md'>
